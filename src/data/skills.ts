...
export const skillCategories: SkillCategory[] = [
  ...
  },
  {
    ...
    icon: '🧠',
    description: 'Teaching machines to see, hear, and think',
    skills: [
      { name: 'PyTorch' },
      { name: 'TensorFlow' },
      { name: 'OpenCV' },
      ...
      { name: 'Whisper STT' },
      { name: 'Kokoro TTS' },
      { name: 'Voice Pipelines' },
      { name: 'Agent Frameworks', tooltip: 'Hermes Agent, MCP, tool protocols' },
      { name: 'GPU Inference' },
      { name: 'MLOps' },
    ],
  },
  {
    ...
    skills: [
      ...
      { name: 'Unity' },
      { name: 'Godot' },
      { name: 'Go Game Servers' },
      { name: 'WebRTC' },
      { name: 'Protobuf' },
      { name: 'Networking/Netcode' },
      { name: 'Spatial Hashing' },
      { name: 'Character Ingestion', tooltip: 'D&D Beyond, Pathbuilder 2e → game mechanics' },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'Caddy' },
      { name: 'Docker Compose' },
      { name: 'Hermes Agent', tooltip: 'Autonomous AI infrastructure agent' },
      { name: 'Networking' },
      { name: 'ZFS' },
      { name: 'Monitoring' },
      { name: 'Self-Hosting' },
